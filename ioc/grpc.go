...
import (
	lgrpc "github.com/asynccnu/be-feedback_help/grpc"
...
func InitGRPCxKratosServer(HelpServer *lgrpc.FeedbackHelpService, ecli *clientv3.Client, l logger.Logger) grpcx.Server {
	type Config struct {
